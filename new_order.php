...
// Fonction pour récupérer le prix unitaire depuis la base de données
...
// Nettoyer le panier - s'assurer que toutes les clés nécessaires existent
...
unset($item); // Déréférencer pour éviter des effets secondaires
