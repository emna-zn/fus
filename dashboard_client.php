...
$stmt->close();
$result = $conn->query("SELECT COUNT(*) as count FROM collections WHERE is_public = 1");
$collections_count = $result->fetch_assoc()['count'];
...
$stmt->close();
$stmt = $conn->prepare("SELECT id, reference, created_at, total_items, status, total_value 
                       FROM orders 
                       WHERE client_id = ? 
...
$stmt->close();
$collections_result = $conn->query("SELECT * FROM collections WHERE is_public = 1 ORDER BY created_at DESC LIMIT 3");
$recent_collections = [];
...
<head>
    ...
    <title>Tableau de bord Client - FUS Denim</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-section">
            ...
            <a href="dashboard_client.php" class="nav-item active">
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="header-title">
                ...
                <p>Bienvenue dans votre espace client FUS Denim</p>
            </div>
        ...
        <div class="welcome-card">
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h3>Bienvenue, <?php echo htmlspecialchars($_SESSION['contact_person']); ?> !</h3>
                    <p>
                        Société: <strong><?php echo htmlspecialchars($_SESSION['company_name']); ?></strong><br>
                        Accédez à nos dernières collections denim, passez des commandes et suivez l'état de vos productions.
                    </p>
                </div>
                <div class="col-lg-3 text-lg-end">
                    <i class="fas fa-gem fa-4x opacity-50"></i>
                </div>
            </div>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box">
                ...
                <div class="stat-value"><?php echo $collections_count; ?></div>
            ...
            <div class="stat-box">
                ...
                <div class="stat-trend">En stock</div>
            </div>
        ...
        <div class="content-grid">
            ...
            <div class="card-modern">
                    ...
                    <table class="table-modern">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $order['total_items']; ?> articles</td>
                                <td>
                ...
                <div class="empty-state">
                    ...
                    <a href="catalog.php" class="btn btn-primary mt-3">Explorer le catalogue</a>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="card-modern">
                <div class="card-header">
                    <div class="card-title">
                        <i class="fas fa-star"></i> Collections récentes
                    </div>
                    <a href="collections.php" class="card-action">Voir tout</a>
                </div>
                
                <?php if (!empty($recent_collections)): ?>
                <div class="collections-grid">
                    <?php foreach($recent_collections as $collection): ?>
                    <a href="collection_view.php?id=<?php echo $collection['id']; ?>" class="collection-card">
                        <div class="collection-icon">
                            <i class="fas fa-layer-group"></i>
                        </div>
                        <div class="collection-name"><?php echo htmlspecialchars($collection['name']); ?></div>
                        <div class="collection-season"><?php echo htmlspecialchars($collection['season']); ?></div>
                        <div class="collection-description">
                            <?php echo htmlspecialchars(substr($collection['description'] ?? 'Collection premium', 0, 100)); ?>...
                        </div>
                    </a>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="card-modern">
                ...
                <div class="quick-actions">
                    <a href="catalog.php" class="action-btn">
                        <i class="fas fa-shopping-cart"></i>
                    ...
                    <a href="catalog.php?filter=popular" class="action-btn">
                ...
                <div class="p-3">
                    <div class="alert alert-success d-flex align-items-center mb-3" role="alert">
                        ...
                        <div>
                            ...
                            <div class="small">Tous les services sont disponibles</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span class="small">Disponibilité</span>
        ...
        <div class="footer">
            <div>
                ...
                <strong>FUS Denim</strong> - Espace Client v1.0
            </div>
            <div>
    ...
    <script>
        ...
        const currentPage = window.location.pathname.split('/').pop() || 'dashboard_client.php';
